...
class SSD(nn.Module):
    ...
    def __init__(self, device,phase, size, base, extras, head, num_classes):
...
# ネットワークのリスト作成
def build_ssd(device,phase, size=300, num_classes=21):
    ...
    return SSD(device,phase, size, base_, extras_, head_, num_classes)
